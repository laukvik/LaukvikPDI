 ...
 * @since	1.5
 */
public class VEvent extends VProperty implements Comparable {
    ...
    /**
     * Creates a new <code>VEvent</code> instance with a set of the most
     ...
     */
    public VEvent(VProperty parent, String summary, GregorianCalendar from, GregorianCalendar to, String description) {
        super(parent);
        setValue(VEVENT);
        setIsGroup(true);
        add(new VProperty(this, START_TIME, formatter.format(from.getTime())));
        add(new VProperty(this, END_TIME, formatter.format(to.getTime())));
        add(new VProperty(this, SUMMARY, summary));
        add(new VProperty(this, DESCRIPTION, description));
        add(new VProperty(this, DURATION, "PT1H"));
    }
     ...
     * @param parent the <code>VCalendar</code> which this event belongs to
     */
    public VEvent(VProperty parent) {
        super(parent);
        setIsGroup(true);
        setValue(VEVENT);
    }
    ...
    public void setDuration(long milliseconds) {
        VProperty p = get(DURATION);
        if (p == null) {
            add(new VProperty(this, DURATION, milliseconds + ""));
        } else {
