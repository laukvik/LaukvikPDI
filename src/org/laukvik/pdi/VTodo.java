...
/**
 * You can use the <code>VTodo</code> class to describe an action you want to
 * do. The action can have the following properties:
 *
 * <ul>
 * <li>Summary
 * <li>Start date
 ...
 * @since	1.5
 */
public class VTodo extends VProperty {
    ...
    /**
     * Constant used to indicate the level of priority. The most important
     * priority is PRIORITY_1 and the least is PRIORITY_9.
     */
    ...
    /**
     * Constant used to describe the time this to-do was created
     */
     ...
     */
    public VTodo(VProperty parent, String summary, int priority, Date due, String comments) {
        super(parent);
        setName(VProperty.BEGIN_GROUP);
        setValue(VTODO);
        setIsGroup(true);
        add(new VProperty(this, SUMMARY, summary));
        add(new VProperty(this, PRIORITY, priority + ""));
        add(new VProperty(this, DUE, (due == null ? "" : formatter.format(due))));
        add(new VProperty(this, COMMENTS, comments));
    }
