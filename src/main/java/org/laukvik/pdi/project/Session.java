...
public class Session {
    ...
    /**
     * Returns the default start date for new projects - which is january 1st of
     * the current year.
     *
     * @return
     */
...
//		}
        ...
        List<VEvent> events = getBusy().listEvents(null, null);
        int x = 0;
        for (VEvent e : events) {
     ...
     * @return
     */
    public List<VEvent> listLockedEvents() {
        return (List<VEvent>) busy.listEvents();
    }
