...
public class TimelineTableModel implements TableModel {
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                return (long) (event.getDuration() / hour);
            case 3:
                return dayFormat.format(event.getStartDate());
            case 4:
                return monthFormat.format(event.getStartDate());
            case 5:
                return yearFormat.format(event.getStartDate());
            case 6:
                return hoursFormat.format(event.getStartDate());
        }
        return "";
    }
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            case 1:
                event.setSummary((String) aValue);
                break;
            case 2:
                event.setDuration(Long.parseLong((String) aValue) * MILLIS_PR_HOUR);
                break;
            case 3:
                /* Day */
                day = (String) aValue;
