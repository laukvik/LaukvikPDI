 ...
 * @since	1.5
 */
public class VCard extends Property{
   ...
   positioning of the object the vCard represents. */
	...
	public final static Parameter INTERNATIONAL = new Parameter("type","intl");
	public final static Parameter DOMESTIC = new Parameter("type","dom");
	
	public final static Parameter HOME = new Parameter("type","home");
	public final static Parameter WORK = new Parameter("type","work");
	
	public final static Parameter POSTAL = new Parameter("type","postal");
	public final static Parameter PARCEL = new Parameter("type","parcel");
