...
/**
 * The Property class is the central class in the API. VCalendar, VCard
 * VEvent and VTodo extends this class.
 * 
...
public class Property {
	 ...
	 */
	public Property( Property parent, boolean isGroup ){
		setParent(parent);
		setIsGroup(isGroup);
	}
	 ...
	 */
	public Property( Property parent, String name, String value ){
		setParent(parent);
		setName(name);
		setValue(value);
	}
	...
	/**
	 * Creates a new <code>Property</code> instance with the specified
	 * name, value and parameter
	 * 
	 * @param name The name to set
	 * @param value The value to set
	 * @param parameter The parameter to set
	 */
	public Property( String name, String value, Parameter... parameter ){
		setName(name);
		setValue(value);
		add( parameter );
	}
	 ...
	 */
	public Property( Property parent, String name, String value, boolean isGroup ){
		setParent(parent);
		setName(name);
		setValue(value);
		setIsGroup(isGroup);
	 ...
	 * 
	 * @return <code>true</code> if it has a parent and <code>false</code> if not
	 */
	...
	/**
	 * Sets whether this Property can contain child properties or not.
	 * When a property is a group the name will automatically become
	 * BEGIN
	 * 
	 ...
	 * 
	 * @return <code>true</code> if the Property is a group and <code>false</code>
	 * if the Property isn't a group
	 */
	...
	/**
	 * Returns a array of all <code>Property</code> objects in the path from
	 * the root <code>Property</code> object to this
	 * 
	 * @return an array of Property objects in the path
	 */
	public Property [] listPath(){
		Vector <Property> items = new Vector <Property>();
		Property par = this;
		int n = 0;
		...
		Vector <Property> items2 = new Vector <Property>();
		n = 0;
		...
		items2.add( this );
		return (Property[]) items2.toArray();
	}
	...
	/**
	 * Sets the parent Property of this Property. If set to null
	 * it will be treated as a root Property.
	 * 
	 ...
	 */
	public Collection <Property> list(){
		return properties;
	}
	
	/**
	 * Returns the Property from the list of children with the 
	 * specified index
	 * 
	...
	/**
	 * Removes the Parameter with the specified index from the
	 * list of Parameters
	 * 
	...
	public void add( String name, String value, Parameter... parameter ){
		Property prop = new Property(name,value,parameter);
		prop.setParent(this);
		properties.add( prop );
	}
	...
	/**
	 * Returns the first Property that has the specified <code>propertyName</code>
	 * 
	 * @param propertyName the name of the Property to use
	 * @return a Property which matched the <code>propertyName</code> and null if
	 * not Property had that name
	 */
	 ...
	 * @return a Collection of Property objects
	 */
	public Collection <Property> list( Parameter... searchParameters ){
		return list( Property.MATCH_ALL, searchParameters );
	}
	 ...
	 * <P>
	 * If <code>groupValue</code> is set to 
	 * <code>MATCH_ALL</code>,
	 ...
	 * @return a collection of Property objects
	 */
	public Collection <Property> listGroups( String... groupValue ){
		Vector <Property> items = new Vector <Property>();
		...
		for (Property prop : properties){
			if (prop.isGroup()){
				...
				for (String testGroupValue : groupValue){
					if (groupValue == null || testGroupValue.equalsIgnoreCase( Property.MATCH_ALL )){
						items.add( prop );
	 ...
	 * propertyName and where they all share the same collection
	 * of searchParameters. The name and value in the searchParameters
	 * are case-insensitive.
	 * 
	 * The following example returns a collection of all properties
	 * with the property name EMAIL and 
	 * 
	 ...
	 * @return a Collection of Property objects
	 */
	public Collection <Property> list( String propertyName, Parameter... searchParameters ){
		Vector <Property> items = new Vector <Property>();
		...
		for (Property prop : properties){
			/* */
			if (propertyName.equalsIgnoreCase( Property.MATCH_ALL ) || prop.getName().equalsIgnoreCase( propertyName )){
				if (searchParameters == null){
					...
					for (Parameter searchParameter : searchParameters){
						...
						for (Parameter parameter : prop.listParameters()){
							log( "Try match: " + searchParameter.getName() + " with " + parameter.getName() );
							if (searchParameter.getName().equalsIgnoreCase( Property.MATCH_ALL )){
							...
							} else if (searchParameter.getValue().equalsIgnoreCase( Property.MATCH_ALL )){
	...
	/**
	 * Writes the value of this Property to the specified OutputStream
	...
	public void writeOut( OutputStream out ) throws IOException{
		try {
			if (isGroup()){
				...
				out.write( Property.BEGIN_GROUP.getBytes() );
				out.write( (":").getBytes() );
				...
				out.write( Property.END_GROUP.getBytes() );
				out.write( (":").getBytes() );
				out.write( getValue().getBytes() );
				out.write( LINE_SEPERATOR );
			} else {
