...
//	private static final String openTitle    = "Please select a file to open";
//	private static final String saveTitle    = "Please enter a filename to save";
	private static final String authorURL = "http://morten.laukvik.no";
//	private static final String exportBinaryTitle = "";
//	private static final String importBinaryTitle = "";
	private static final long serialVersionUID = 1L;

	private PropertyTreeModel treeModel = new PropertyTreeModel(new Property(null));
	private javax.swing.JTree tree = new javax.swing.JTree(treeModel);
	private ParameterTableModel tableModel = new ParameterTableModel(null);
...
//    }
	...
	public void handleAddGroup(){
        Property child = new Property(null);
        child.setName( Property.BEGIN_GROUP );
	...
	public void handleAddParameter(){
        tableModel.addParameter( new Parameter("name","value"), table );
        setSaved(false);
	}
	...
	public void open( URL url ){
		try {
			...
			Property prop = PDIManager.read( url );
	...
	public void open( File file ){
		try {
			...
			tree.setEditable(false);
			setOpenedFile( null );
			Property prop = PDIManager.read( file );
			treeModel.setRoot( prop );
			setOpenedFile( file.getAbsolutePath() );
			tree.updateUI();
			tree.setEditable(true);
    ...
    public void handleGotoURL(){
    		Property prop = (Property)tree.getLastSelectedPathComponent();
	...
	public void valueChanged(TreeSelectionEvent e) {
		...
		if (e.getNewLeadSelectionPath() != null) {
			...
			if (last != null) {
				...
				String stat = "";				
				for (Property prop1 : prop.listPath()){
					stat += prop1.getValue() + "/";
				}
	 ...
	 * 
	 * Version 2
	 * TODO - Implement delete of multiple properties
	 * TODO - Add progressbar when opening files
	 * 
	 * Version 3
	 * TODO - Add support for the standard
	 * TODO - Add support for images
	 * TODO - Add export to XML
	 * 
	 * Version 4
	 * TODO - Add about handler
	 *
