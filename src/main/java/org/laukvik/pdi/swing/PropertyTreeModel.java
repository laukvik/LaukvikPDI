...
/**
 * A class which makes it much easier to work with trees than using the traditional
 * way of using the <code>add</code> methods.
 * 
...
public class PropertyTreeModel extends DefaultTreeModel {
	...
	public void setRootProperty( Property property ){
	}

	public Property getChild(Object parent, int index) {
	...
	public int getIndexOfChild(Object parent, Object child) {
		...
		Property chi = (Property) child;
		Collection <Property> properties = par.list();
		int index = -1;
	...
	public void addProperty(JTree tree, Property child) {	
		TreePath path = tree.getLeadSelectionPath();
		Property parent = (Property) path.getLastPathComponent();
		if (parent == null){
			// Do nothing
	...
	public void addGroup(JTree tree, Property child) {	
		TreePath path = tree.getLeadSelectionPath();
		Property parent = (Property) path.getLastPathComponent();
		if (parent.isGroup()){
	 ...
	 */
	protected void fireTreeStructureChanged(Property oldRoot, Object path [] ) {
