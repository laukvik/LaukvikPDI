...
public class ParameterTableModel extends AbstractTableModel {
    ...
    public ParameterTableModel(VProperty property) {
		this.property = property;
	}

    public void setProperty(VProperty property) {
		this.property = property;
		fireTableDataChanged();
	}

    public VProperty getProperty() {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		if (property == null){ return null; }
            VParameter param = property.getParameter(rowIndex);
		switch (columnIndex){
    ...
    public void addParameter(VParameter parameter, JTable table) {
